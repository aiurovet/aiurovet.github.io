...
$.fn.spinner = function(options) {
  ...
  this.initUI = function(options) {
    ...
    var less = this.isList ? "prev" : "less";
    var more = this.isList ? "next" : "more";
    var readonly = this.isList ? "readonly" : "";
  ...
  this.onBlur = function() {
    var text = this.isList ? _jqValue.text() : _jqValue.val();
  ...
  this.update = function(step) {
    var newData = (this.isList ? this.index : (this.value ?? 0)) + (step ?? 0);
