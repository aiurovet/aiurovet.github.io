  ...
  event.waitUntil(
    caches.open("greet-o-quote").then((cache) => {
      return cache.addAll([
        ...
        "/lib/ux/scripts/lookimage.js?v=0.1.0",
        "/lib/ux/scripts/looktext.js?v=0.1.0",
        "/lib/ux/scripts/listedit.js?v=0.1.0",
        "/lib/ux/scripts/msgbox.js?v=0.1.0",
        "/lib/ux/scripts/select.js?v=0.1.0",
        "/lib/ux/scripts/select-direction.js?v=0.1.0",
        "/lib/ux/scripts/select-align.js?v=0.1.0",
        "/lib/ux/scripts/select-font.js?v=0.1.0",
